...
const directions: Direction[] = [
  {
    ...
    description:
      "Побудуємо власний рух, характер і подачу. Дитячі та дорослі групи в Білій Церкві — від бази до сценічних постановок.",
  ...
  },
  {
    ...
    description:
      "Грація, пластика, характер. Заняття для дорослих у D4YS Studio — стиль, що підкреслює індивідуальність і вчить володіти тілом на всі 100%.",
    ...
    >
      ...
      >
        ...
        <p className="mt-6 text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          Два напрямки танців у D4YS Studio — хореографія та Jazz-Funk. Групи для дітей та дорослих у Білій Церкві.
        </p>
      </motion.div>
