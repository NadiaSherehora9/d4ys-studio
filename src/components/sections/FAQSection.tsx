...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Ні, попередній досвід не потрібен! У D4YS Studio є групи для різних рівнів підготовки — від початківців до просунутих танцюристів. Дитячі та дорослі групи в Білій Церкві.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Так, D4YS Studio (ді форс студія) має дитячі групи для різних вікових категорій у Білій Церкві. Діти можуть займатися Хорео та Jazz-Funk. Розклад дитячих танців можна дізнатися у нас в Instagram @d4ys_studio.",
  },
  {
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto text-lg leading-relaxed">
            Відповіді на популярні запитання про танцювальну студію D4YS в Білій Церкві
          </p>
        </motion.div>
